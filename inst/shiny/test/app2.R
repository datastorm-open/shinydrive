...
#     dt <- all_files()
#
#     dt$Download <- dnl_button("download_user",
#                               uniquenames(),
#                               icon("file-export"))
#
#
...
#
#
#     dt$Select <- input_checkbox_ui("remove_mult_users", uniquenames(), checked = FALSE)
#     datatable(
#       data = dt,
#       colnames = make_title(names(dt)),
#       rownames = FALSE,
...
#     if(!is.null(input$scenario_dir_desc)){
#       fp <- file.path(save_dir,input$scenario_dir_desc,
#                       paste0(tools::file_path_sans_ext(dt_sel$names),"_",
#                              dt_sel$date_time, ".",
#                              tools::file_ext(dt_sel$names)))
#     }else{
#       fp <- file.path(save_dir,
#                       paste0(tools::file_path_sans_ext(dt_sel$names),"_",
#                              dt_sel$date_time, ".",
...
#   observeEvent(input$download_user, {
#     fp <- download_user()
#     output[[paste0("download_user", input$download_user)]] <- downloadHandler(
#       filename <- function() {
#         print("here")
#         "toto"
#       },
...
#     remove_mult_users_input
#   })
#
#   supred_raw_all <- reactive({
#     req(all_output())
#     tf_input <- all_output()
#     tf_input <- reactiveValuesToList(input)[tf_input]
#     tf_input
#     selected_users <- unlist(tf_input)
#     selected_users <- selected_users[which(selected_users)]
#     selected_users <- names(selected_users)
#     selected_users <- gsub("remove_mult_users-check_", "", selected_users)
#     print(selected_users)
#     dt <- all_files()
#     all_names <- uniquenames()
#     dt_sel <- dt[all_names %in%  selected_users]
#     dt_sel
#   })
#
#
